...
client.login("NDc2MDA4MTgyMTI1NDI4NzM2.Dk3bng.orfnvSQz_t1woeNwdpXDtN8Je6Y");
...
client.on('message', async message => { 
    ...
    if(message.content === "XXXTENTACION"){
        message.reply("RIP");
        console.log('quelqu un a trouver l easter egg');
    }
    ...
    if(message.content === prefix + "help") {
      ...
      .addField(":tools: Modération", "Fais `o!mod` pour voir mes commandes de modération !")
      .addField(":tada: Fun", "Fais `o!fun` pour voir mes commandes d'animation !")
      .setFooter("Menu d'aide - Oyanna")
      .setTimestamp()
    ...
    if(message.content === prefix + "mod") {
      ...
      .setThumbnail(message.author.avatarURL)
      .addField("o!kick <@user>", "Kick l'utilisateur !")
      .addField("o!ban <@user>", "Ban l'utilisateur !")
      .addField("o!warn <@user>", "Avertie un utilisateur")
      .addField("o!clear nombre", "Supprime le nombre de messages indiqué")
      .addField("o!mute <@user>", "Mute l'utilisateur mentionné")
      .addField("o!unmute <@user>", "Unmute l'utilisateur mentionné")
      .setFooter("Commande modération - Oyanna")
      .setTimestamp()
    ...
    if(message.content === prefix + "fun") {
      ...
      .setThumbnail(message.author.avatarURL)
      .addField("o!stats", "Le bot vous envoie des informations sur votre profil !")
      .addField("o!info", "Donne des indormations sur le bot et le serveur !")
      .setFooter("Commande modération - Oyanna")
      .setTimestamp()
